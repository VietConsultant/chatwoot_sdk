...
class ChatwootChatTheme extends ChatTheme {
  ...
  const ChatwootChatTheme(
      ...
      Color userAvatarImageBackgroundColor = Colors.black,
      EdgeInsets attachmentButtonMargin = EdgeInsets.zero,
      EdgeInsets dateDividerMargin = EdgeInsets.zero,
      EdgeInsets inputPadding = EdgeInsets.zero,
      EdgeInsets sendButtonMargin = EdgeInsets.zero,
      EdgeInsets statusIconPadding = EdgeInsets.zero,
